...
phy$Sample <- factor(phy$Sample, levels = c("Primary Level", "Secondary Level", "Tertiary education", "Diploma or University degree"))
...
ggsave(filename = "plots/education-relabund-percents.pdf", dpi = 600)
