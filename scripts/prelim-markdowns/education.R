...
psbclass %>% plot_composition(group_by = "HighestLevelEducation") +
...
ggviolin(ps.meta, x = "HighestLevelEducation", y = "Shannon$Shannon",
         add = "boxplot", fill = "HighestLevelEducation", palette = four_color, title = " ", ylab = "Shannon's Diversity Index", xlab = " ") +
  theme(legend.position = "none") +
...
ait %>% dist_bdisp(variables = "HighestLevelEducation") %>% bdisp_get()
